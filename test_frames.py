...
parser.add_argument('--dataset', default ='dataset', help='path to test dataset')
parser.add_argument('--real', default ='original', help='real folder name')
parser.add_argument('--fake', default ='altered', help='fake folder name')
...
if __name__ == '__main__':
    ...
    # real data
    count_vid, correct = classify_frames(vgg_ext, model, path_real, 1)
    tol_count_vid = tol_count_vid + count_vid
    tol_correct = tol_correct + correct

    # fake data
    count_vid, correct = classify_frames(vgg_ext, model, path_fake, 0)
    tol_count_vid = tol_count_vid + count_vid
    tol_correct = tol_correct + correct
